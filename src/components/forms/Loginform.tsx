    ...
    <div className="flex flex-col gap-6">
        <Card>
            <CardHeader className="text-center">
                ...
                <CardDescription className="text-gray-400 ">Login with your Google or Github account</CardDescription>
            </CardHeader>
               ...
               <div className="flex flex-col gap-4">
                <form action={async () => {
                    ...
                    {/* <Button className="w-full" variant="outline">
                        ...
                        Google</Button> */}
                        <GeneralSubmitButton width="w-full" variant="outline" text="Login with Google" icon={<Google/>}/>
                </form>
                ...
                <form action={async () => {
                    ...
                    await signIn("github", {
                        ...
                        <GeneralSubmitButton width="w-full" variant="outline" text="Login with Github" icon={<Github/>}/>
                </form>
            ...
            <Checkbox/>
        <div className="text-center text-balance text-xs text-gray-300">
            By clicking the continue, you agree to our terms and private policiy .
        </div>
    </div>
    )
};
